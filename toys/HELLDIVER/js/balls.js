var balls_colle = [
    ...
    { name: "Dark Fluid Vessel", commands: "ulrduu", class: "固定战略", icon: "./img/icons/General Stratagems/Dark Fluid Vessel.svg" },
    ...
    { name: "反坦克地雷", commands: "dluu", class: "自动防御塔", icon: "./img/icons/Engineering Bay/Anti-Tank Mines.svg" },
    ...
    // { name: "meteor-launcher", commands: "", class: "武器装备", icon: "" },

var balls_colle = [
    ...
    { name: "飞鹰重新武装", commands: "uulur", class: "固定战略", icon: "./img/icons/Hanger/Eagle Rearm.svg" },
    ...
    { name: "飞鹰机枪扫射", commands: "urr", class: "飞鹰系列", icon: "./img/icons/Hanger/Eagle Strafing Run.svg" },
    { name: "飞鹰空袭", commands: "urdr", class: "飞鹰系列", icon: "./img/icons/Hanger/Eagle Airstrike.svg" },
    { name: "飞鹰集束炸弹", commands: "urddr", class: "飞鹰系列", icon: "./img/icons/Hanger/Eagle Cluster Bomb.svg" },
    { name: "飞鹰烟雾攻击", commands: "urud", class: "飞鹰系列", icon: "./img/icons/Hanger/Eagle Smoke Strike.svg" },
    { name: "飞鹰凝固汽油弹空袭", commands: "urdu", class: "飞鹰系列", icon: "./img/icons/Hanger/Eagle Napalm Airstrike.svg" },
    { name: "飞鹰110MM火箭巢", commands: "urul", class: "飞鹰系列", icon: "./img/icons/Hanger/Eagle 110MM Rocket Pods.svg" },
    { name: "飞鹰500KG炸弹", commands: "urddd", class: "飞鹰系列", icon: "./img/icons/Hanger/Eagle 500KG Bomb.svg" },
    ...
    { name: "照明弹", commands: "rrll", class: "轨道轰炸系列", icon: "./img/icons/General Stratagems/Orbital Illumination Flare.svg" },
    { name: "轨道毒气攻击", commands: "rrdr", class: "轨道轰炸系列", icon: "./img/icons/Bridge/Orbital Gas Strike.svg" },
    { name: "轨道电磁冲击波攻击", commands: "rrld", class: "轨道轰炸系列", icon: "./img/icons/Bridge/Orbital EMS Strike.svg" },
    { name: "轨道加特林火力网", commands: "rdluu", class: "轨道轰炸系列", icon: "./img/icons/Orbital Cannons/Orbital Gatling Barrage.svg" },
    { name: "轨道炮精准攻击", commands: "rru", class: "轨道轰炸系列", icon: "./img/icons/Bridge/Orbital Precision Strike.svg" },
    { name: "轨道烟雾攻击", commands: "rrdu", class: "轨道轰炸系列", icon: "./img/icons/Bridge/Orbital Smoke Strike.svg" },
    { name: "轨道空爆攻击", commands: "rrr", class: "轨道轰炸系列", icon: "./img/icons/Orbital Cannons/Orbital Airburst Strike.svg" },
    { name: "轨道炮攻击", commands: "ruddr", class: "轨道轰炸系列", icon: "./img/icons/Orbital Cannons/Orbital Railcannon Strike.svg" },
    { name: "轨道120MM高爆弹火力网", commands: "rrdlrd", class: "轨道轰炸系列", icon: "./img/icons/Orbital Cannons/Orbital 120MM HE Barrage.svg" },
    { name: "轨道380MM高爆弹火力网", commands: "rduuldd", class: "轨道轰炸系列", icon: "./img/icons/Orbital Cannons/Orbital 380MM HE Barrage.svg" },
    { name: "轨道游走火力网", commands: "rdrdrd", class: "轨道轰炸系列", icon: "./img/icons/Orbital Cannons/Orbital Walking Barrage.svg" },
    { name: "轨道激光炮", commands: "rdurd", class: "轨道轰炸系列", icon: "./img/icons/Orbital Cannons/Orbital Laser.svg" },
